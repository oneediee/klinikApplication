    ...
    <nav class="navbar navbar-default navbar-static-top">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="obat.php"><font face="Lucida Bright" size="+1" color="green"><b>Obat</b></font></a></li>
            <li><a href="pasien.php"><font face="Lucida Bright" size="+1" color="green"><b>Pasien</b></font></a></li>
            <li class="active"><a href="pegawai.php"><font face="Lucida Bright" size="+1" color="green"><b>Pegawai</b></font></a></li>
...
<br>
    <div class="container">
        ...
        <table id="myTable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
            <?php include 'proses/pegawai/tbl_peg.php';
            while($d = mysql_fetch_array($sql)){
                ...
                <tr>
                    ...
                    <td><?php if($d['status_peg']=="administrator"){
                            echo "".$d['status_peg']."";
                        }elseif($d['status_peg']=="apoteker"){
                            echo "".$d['status_peg']."";
                        }
                        ?></td>
                     <td>  <a href="#" class="btn btn-danger modal_delete" id="<?php echo $d['kd_peg']; ?>">
    ...
    <div class="modal fade" id="<?php echo $data2->kd_peg; ?>">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form class="form-horizontal" role="form" method="post" action="updatepegawai.php?kd_peg=<?php echo $data2->kd_peg; ?>" enctype="multipart/form-data">
                      <div class="form-group">
                          <div class="col-sm-2">
                              <label  class="control-label">Nama</label>
                          </div>
                          <div class="col-sm-10">
                              <input type="text " class="form-control" placeholder="Nama" value="<?php echo $data2->nm_peg; ?>" name="nm_peg" required="required">
                          </div>
                      </div>
                        <div class="form-group">
                          <div class="col-sm-2">
                          ...
                          <div class="col-sm-10">
                              <input type="text " class="form-control" disabled placeholder="Username" value="<?php echo $data2->username; ?>" name="username" required="required">
                          </div>
                      </div>
                        <div class="form-group">
                          <div class="col-sm-2">
                          ...
                          <div class="col-sm-10">
                              <input type="text " class="form-control" disabled placeholder="Password" value="<?php echo $data2->password; ?>" name="password" required="required">
                          </div>
                      </div>
                  ...
                  <div class="form-group">
                            <label>Akses</label>
                            <select name="status_peg" id="status" class="form-control" value="<?php echo $data2->status_peg; ?>">
                                <option value=""></option>
    ...
    <div class="modal fade" id="Mymodal" role="dialog">
                ...
                <div class="modal-body">
                    <form id="formModal" action="" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="kd_peg" id="kd_peg" value="<?php include 'proses/pegawai/kd_peg.php';?>" readonly>
                        </div>
                        <div class="form-group">
                            <label>Nama Pegawai</label>
                            <input type="text" class="form-control" id="nm_peg" name="nm_peg" required>
                        </div>
                        <div class="form-group">
                            <label>Username</label>
                            <input maxlength="15" type="text" class="form-control" id="user" name="user" required>
                        </div>
                        <div class="form-group">
                            <label>Password</label>
                            <input maxlength="15" type="text" class="form-control" id="pass" name="pass" required>
                        </div>
                        <div class="form-group">
                            <label>Akses</label>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#myTable').dataTable({
                    ...
                    buttons: [  { extend: 'excel', exportOptions: {columns: ':visible'} },
                        ...
                        { extend: 'colvisGroup', text: 'Data pegawai', show: [ 1, 2, 3, 4, 5 ], hide: [ 0,6 ] },
            ...
            function ModalAdd() {
                $('#Mymodal').modal('show');
                $('#btnS').text("Simpan");
                $('#formModal').attr({action: "proses/pegawai/tambah.php"});
                $('#formModal')[0].reset();
                $('#kd_dkt')[0].reset();
                $('.modal-title').text(" Add Data Pegawai");
            }
            //Edit Data
            $(".modal_edit").click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#telp').val(json[5]);
                        $('#Mymodal').modal('show');
                        $('#formModal').attr({action: "proses/pegawai/edit_proses.php"});
                    }
                });
            })
            //Delete Data
            $(".modal_delete").click(function(){
                ...
                if(r == true){
                    ...
                    window.location.assign("pegawai.php");
                }
            });
        </script>
    </body>

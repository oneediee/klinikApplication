    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbar-ex-collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="pasien.php"><font face="Lucida Bright" size="+1" color="green"><b>Pasien</b></font></a></li>
...
<div class="container">
    ...
    <table id="myTable" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
        <?php include 'proses/pasien/tbl_psn.php';
        while($d = mysql_fetch_array($sql)){
            ?>
            <tr>
                <td><?php echo $d['kd_psn']; ?></td>
                <td><?php echo $d['nm_psn']; ?></td>
                <td><?php echo $d['almt_psn']; ?></td>
                <td><?php echo $d['gender_psn']; ?></td>
                <td><?php echo $d['umur_psn']; ?></td>
                <td><?php echo $d['telp_psn']; ?></td>
                <td align="center">
                    <a href="#" class="btn btn-primary modal_edit" id="<?php echo $d['kd_psn']; ?>">
                        <i class="fa fa-edit"></i> Edit</a></td>
                   <td> <a href="#" class="btn btn-danger modal_delete" id="<?php echo $d['kd_psn']; ?>">
...
<div class="modal fade" id="Mymodal" role="dialog">
            ...
            <div class="modal-body">
                <form id="formModal" action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kd_psn" id="kd_psn" value="<?php include 'proses/pasien/kd_psn.php';?>" readonly>
                    </div>
                    <div class="form-group">
                        <label>Nama Pasien</label>
                        <input type="text" class="form-control" id="nm_psn" name="nm_psn" required>
                    </div>
                    <div class="form-group">
                        <label>Alamat Pasien</label>
                        <textarea name="almt" id="almt" rows="3" class="form-control" required></textarea>
                    </div>
                    <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#myTable').dataTable({
                ...
                buttons: [  { extend: 'excel', exportOptions: {columns: ':visible'} },
                    ...
                    { extend: 'colvisGroup', text: 'Data pasien', show: [ 1, 2, 3, 4, 5 ], hide: [ 0,6 ] },
        ...
        function ModalAdd() {
            $('#Mymodal').modal('show');
            $('#btnS').text("Simpan");
            $('#formModal').attr({action: "proses/pasien/tambah.php"});
            $('#formModal')[0].reset();
            $('#kd_dkt')[0].reset();
            $('.modal-title').text(" Add Data Pasien");
        }
        //Edit Data
        $(".modal_edit").click(function(){
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    $('#telp').val(json[5]);
                    $('#Mymodal').modal('show');
                    $('#formModal').attr({action: "proses/pasien/edit_proses.php"});
                }
            });
        })
        //Delete Data
        $(".modal_delete").click(function(){
            ...
            if(r == true){
                ...
                window.location.assign("pasien.php");
            }
        });
    </script>
</body>
